...
static std::vector<std::string> s_Preset_print_options {
    ...
    "bridge_speed", "internal_bridge_speed", "gap_infill_speed", "travel_speed", "travel_speed_z", "initial_layer_speed", "first_layer_speed_over_raft",
    "outer_wall_acceleration", "initial_layer_acceleration", "first_layer_acceleration_over_raft", "top_surface_acceleration", "default_acceleration", "skirt_type", "skirt_loops", "skirt_speed","min_skirt_length", "skirt_distance", "skirt_start_angle", "skirt_height","single_loop_draft_shield", "draft_shield",
